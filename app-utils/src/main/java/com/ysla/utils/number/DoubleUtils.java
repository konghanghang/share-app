...
public class DoubleUtils {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(d1-d2-d3);
        System.out.println(DoubleUtils.sum(d1, d2, d3));
        System.out.println(DoubleUtils.sub(d1, d2, d3));
        System.out.println(d1/d2);
        System.out.println(DoubleUtils.div(d1,d2));
    }
